...
public class SelectMenuModel {
    ...
    public void requestLayoutView(ReaderDataHolder readerDataHolder,boolean isDictionary) {
        ...
        final float screenHeight = readerDataHolder.getReaderTouchHelper().getContentHeight(readerDataHolder.getAppContext());
        final float screenWidth = readerDataHolder.getReaderTouchHelper().getContentWidth(readerDataHolder.getAppContext());
