...
import com.onyx.android.plato.adapter.WifiSettingAdapter;
...
public class WifiActivity extends Activity implements View.OnClickListener {
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart(WifiActivity.class.getSimpleName());
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd(WifiActivity.class.getSimpleName());
