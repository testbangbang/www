...
public class InitMainViewFunctionBarAction extends BaseAction<DataBundle> {
    ...
    public void execute(DataBundle dataBundle, RxCallback baseCallback) {
        ...
        functionBarModel.itemModels.add(new FunctionBarItem(ViewConfig.FunctionModule.SHOP,ShopFragment.class.getName(), dataBundle.getAppContext().getString(R.string.shop_name), R.mipmap.ic_shop));
