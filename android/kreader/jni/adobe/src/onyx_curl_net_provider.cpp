...
#define  LOG_TAG    "onyx_curl_net_provider"
...
{
public:
    CurlStream(const dp::String& method, const dp::String& url,
               dpio::StreamClient * client, dpio::Stream * data_to_post) :
        method_(method),
        client_(client),
...
OnyxCurlNetProvider::OnyxCurlNetProvider()
{
}
...
dpio::Stream* OnyxCurlNetProvider::open( const dp::String& method,
                                     const dp::String& url,
