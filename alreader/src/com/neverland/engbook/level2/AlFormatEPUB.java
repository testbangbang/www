...
public class AlFormatEPUB extends AlAXML {
    ...
    static final int UNKNOWN_EPUB_SOURCE_NUM = 0x7fff;

    String		    currentFile = null;
    int			    currentNum = UNKNOWN_EPUB_SOURCE_NUM;
    ...
    int			    toc_state = 0;
    String		    toc_point = null;
    int 			toc_section = -1;
    StringBuilder	toc_text = new StringBuilder();
    String		    toc_base;
    ArrayList<AlOneEPUBTOC>		listTOC = new ArrayList<AlOneEPUBTOC>();
    static final int		TOC_NAVMAP = 0x01;
    static final int		TOC_NAVPOINT = 0x02;
    static final int		TOC_NAVLABEL = 0x04;
    static final int		TOC_TEXT = 0x08;

    HashMap<String, AlOneEPUBIDItem>	mapId = new HashMap<String, AlOneEPUBIDItem>();
    ArrayList<AlOneEPUBItem>			listFiles = new ArrayList<AlOneEPUBItem>();
    ...
    void addFiles2Read(String fname, int sp) {
        if (allState.isOpened) {
