...
public class BaseHandler {
    ...
    private Point bookmarkPosition(Bitmap bitmap) {
        ...
        point.set(readerDataHolder.getReaderTouchHelper().getPageViewWidth() - bitmap.getWidth(), 10);
        return point;
    }
    ...
    public static String getTouchAreaCode(ReaderDataHolder readerDataHolder, final MotionEvent event) {
        int displayWidth = readerDataHolder.getReaderTouchHelper().getPageViewWidth();
        int displayHeight = readerDataHolder.getReaderTouchHelper().getPageViewHeight();
