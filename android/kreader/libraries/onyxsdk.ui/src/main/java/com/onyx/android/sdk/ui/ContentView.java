...
import com.onyx.android.sdk.ui.util.ContentViewUtil;
import com.onyx.android.sdk.ui.util.ContentViewUtil.SelectionMode;
...
public class ContentView extends RelativeLayout {
    public enum TouchDirection {Horizontal, Vertical, Both}
    ...
    private int dialogSetValueHeight = -1, dialogSetValueWidth = -1, dialogSetValuePositionX = -1,
            dialogSetValuePositionY = -1, dialogSetValueLayoutID = R.layout.dialog_set_value;
    private ContentItemView.HyphenCallback hyphenCallback = null;
    private TouchDirection touchDirection = TouchDirection.Horizontal;
    ...
    public void setTouchDirection(TouchDirection touchDirection) {
     ...
     *  if forceRefillContentGrid ->true ,contentView will throw all child views at once.and refill
     *  all new views.
     */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP:
                PageTurningDirection direction = detectDirection(ev);
...
//                v.requestFocus();
    ...
    public void showFunctionLayout(SelectionMode selectionMode) {
