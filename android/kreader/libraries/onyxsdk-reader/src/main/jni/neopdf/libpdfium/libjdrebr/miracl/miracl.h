...
extern int aes_encrypt(aes *pCtrl, char *pInput, int nLen, char *pOutput, BOOL bPadding);
extern int aes_decrypt(aes *pCtrl, char *pInput, int nLen, char *pOutput, BOOL bPadding);
