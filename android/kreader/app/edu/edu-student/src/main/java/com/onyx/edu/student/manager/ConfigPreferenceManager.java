package com.onyx.edu.student.manager;
...
public class ConfigPreferenceManager extends PreferenceManager {
    ...
    public static boolean hasImportContent(Context context) {
        return getBooleanValue(context, IMPORT_CONTENT_IN_FIRST_BOOT_TAG, false);
    }

    public static void setImportContent(Context context, boolean imported) {
        setBooleanValue(context, IMPORT_CONTENT_IN_FIRST_BOOT_TAG, imported);
    }
    ...
    public static Intent getContentBrowserSettingsIntent() {
        Intent intent = new Intent();
