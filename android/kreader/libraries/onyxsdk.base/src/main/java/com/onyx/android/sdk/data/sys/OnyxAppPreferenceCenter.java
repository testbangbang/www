...
public class OnyxAppPreferenceCenter
{
    ...
    public static synchronized OnyxAppPreference getApplicationPreference(Context context, String ext)
    {
        if (!sInitialized) {
            if (!init(context)) {
                return null;
     ...
     * @return
     */
    public static synchronized boolean setAppPreference(Context context, String ext, String appName, String pkg, String cls)
    {
        if (!sInitialized) {
            if (!init(context)) {
                return false;
    ...
    public static synchronized boolean removeAppPreference(Context context, String ext)
    {
        if (!sInitialized) {
            if (!init(context)) {
                return false;
