...
import com.onyx.android.sdk.data.util.DateTimeUtil;
...
public class GObject {
    ...
    public boolean putDateAsString(final String key, final Date value) {
        if (isDummyObject()) {
            return false;
        }
        if (value == null) {
            ...
            backend.put(key, DateTimeUtil.formatDate(value));
        }
        invokeCallback(key);
        return true;
    }
