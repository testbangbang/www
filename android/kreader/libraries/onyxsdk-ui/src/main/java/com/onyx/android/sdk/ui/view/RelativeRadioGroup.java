 ...
 * <p>See {@link android.R.styleable#RadioGroup RelativeRadioGroup Attributes},
    ...
    public RelativeRadioGroup(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            TypedArray attributes = context.obtainStyledAttributes(
                    attrs, R.styleable.com_nachorater_RadioGroup, 0,
                    android.R.style.Widget_CompoundButton_RadioButton);

            int value = attributes.getResourceId(R.styleable.com_nachorater_RadioGroup_android_checkedButton,
                    View.NO_ID);
            if (value != View.NO_ID) {
                mCheckedId = value;
            }
