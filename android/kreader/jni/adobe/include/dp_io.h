...
public:
	...
	/**
	 *  Adjusts the modified stream (which is possibly modified after the init, for e.g. size etc)
	 *  using the system commands and populates.
	 */
	virtual size_t adjustModifiedStream() { return 0; }
	/**
