...
extern P1363_API BOOL AES_ENCRYPT_STRING(octet *k,octet *m,char* pInput,int nInputLen,octet *c,char** pOutput, int* nOutputLen, BOOL bPadding);
extern P1363_API BOOL AES_DECRYPT_STRING(octet *k,octet *c,char* pInput,int nInputLen,octet *m,char** pOutput, int* nOutputLen, BOOL bPadding);

extern P1363_API BOOL file_AES_encrypt(char* szKey, int nKeyLen, char* szInput, char* szOutput);
extern P1363_API BOOL file_AES_decrypt(char* szKey, int nKeyLen, char* szInput, char* szOutput);

extern P1363_API BOOL string_AES_decrypt(char* szKey, char* szInput, int nInputLen, char** szOutput, int* nOutputLen, BOOL bPadding);
extern P1363_API BOOL string_AES_encrypt(char* szKey, char* szInput, int nInputLen, char** szOutput, int* nOutputLen, BOOL bPadding);

extern P1363_API void FreePtr_AES(void* ptr);

extern P1363_API int GenerateAESKey(char** ppKey);
extern P1363_API int GenerateRandomNum(char** pRandomNum, int* nRandomLen);

extern P1363_API void Hash_256(char* pInputBuf, int nInputBufLen, char** pOutputBuf, int* nOutputBufLen);
