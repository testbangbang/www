...
public class VipInstructionsDialog extends Dialog {
    ...
    public void show() {
        ...
        attributes.width = (int) (screenWidth * Utils.getValuesFloat(R.integer.book_info_dialog_width));
        attributes.height = (int) (screenHeight * Utils.getValuesFloat(R.integer.book_info_dialog_height));
