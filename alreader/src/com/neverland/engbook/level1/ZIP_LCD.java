...
public class ZIP_LCD {
     ...
     public static final void ReadBuffer(ZIP_LCD zipLCD, AlFiles a, int len) {    	 
     ...
     public static final void ReadExtra(ZIP_LCD zipLCD, AlFiles a) {
     ...
     public static final void ReadLCD(ZIP_LCD zipLCD, AlFiles a) { 		
