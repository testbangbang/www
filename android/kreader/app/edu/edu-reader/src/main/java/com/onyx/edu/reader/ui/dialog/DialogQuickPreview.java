...
import com.onyx.edu.reader.ui.actions.GetPageNumberFromPositionAction;
import com.onyx.edu.reader.ui.actions.GetPositionFromPageNumberAction;
import com.onyx.edu.reader.ui.actions.GetTableOfContentAction;
...
import com.onyx.edu.reader.ui.view.PreviewViewHolder;
...
public class DialogQuickPreview extends OnyxBaseDialog {
    ...
    private void setupLayout() {
        ...
        textViewProgress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DialogGotoPage.show(readerDataHolder, false, new BaseCallback() {
                    @Override
                    public void done(BaseRequest request, Throwable e) {
                        DialogQuickPreview.this.dismiss();
                    }
