...
public class ReaderLayerMenuRepository {
    ...
    public static ReaderLayerMenuItem[] fixedPageMenuItems = new ReaderLayerMenuItem[] {
        ...
        new ReaderLayerMenuItem(ReaderMenuItem.ItemType.Item, ReaderMenuAction.ZOOM_TO_WIDTH, null, R.string.reader_layer_menu_zoom_to_width, "", R.drawable.ic_dialog_reader_menu_scale_fit_width),
        ...
        new ReaderLayerMenuItem(ReaderMenuItem.ItemType.Item, ReaderMenuAction.ROTATION_ROTATE_0, null, R.string.reader_layer_menu_rotation_rotate0, "", R.drawable.ic_dialog_reader_menu_revolve_up),
        new ReaderLayerMenuItem(ReaderMenuItem.ItemType.Item, ReaderMenuAction.ROTATION_ROTATE_270, null, R.string.reader_layer_menu_rotation_rotate270, "", R.drawable.ic_dialog_reader_menu_revolve_right),
        new ReaderLayerMenuItem(ReaderMenuItem.ItemType.Item, ReaderMenuAction.ROTATION_ROTATE_180, null, R.string.reader_layer_menu_rotation_rotate180, "", R.drawable.ic_dialog_reader_menu_revolve_down),
