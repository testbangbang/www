...
public class MyTextView extends View {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        TypedArray typed_array = context.obtainStyledAttributes(attrs, R.styleable.MyTextView);
        textSize = typed_array.getDimensionPixelSize(R.styleable.MyTextView_textSize, 35);
    }
