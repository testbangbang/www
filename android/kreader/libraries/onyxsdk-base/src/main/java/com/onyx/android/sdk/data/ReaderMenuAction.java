...
public enum ReaderMenuAction {
    ...
    MORE, TTS, FRONT_LIGHT, REFRESH, SETTINGS, GOTO_PAGE, NAVIGATE_BACKWARD, NAVIGATE_FORWARD, DICT, SEARCH, EXIT,JUMP_PAGE,

    //scribble menu
    SCRIBBLE_WIDTH, SCRIBBLE_WIDTH1, SCRIBBLE_WIDTH2, SCRIBBLE_WIDTH3, SCRIBBLE_WIDTH4, SCRIBBLE_WIDTH5,
    SCRIBBLE_SHAPE, SCRIBBLE_PENCIL, SCRIBBLE_BRUSH, SCRIBBLE_LINE, SCRIBBLE_TRIANGLE, SCRIBBLE_CIRCLE, SCRIBBLE_SQUARE,
    SCRIBBLE_TEXT,
