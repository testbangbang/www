...
import com.onyx.knote.actions.scribble.DocumentCreateAction;
import com.onyx.knote.actions.scribble.DocumentEditAction;
        ...
        BaseCallback baseCallback = new BaseCallback() {
            ...
            public void done(BaseRequest request, Throwable e) {
                if (!request.isAbort() && e == null) {
                    ...
                    mNoteManager.post(new UpdateScribbleTitleEvent(mNoteTitle.get()));
                }
