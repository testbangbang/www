 ...
 * 1. All in host coordinates system including page and viewport
 * 2. when rendering, calculate the viewport in host coordinates system and ask plugin to render
 *    visible pages and visible part in viewport and render the visible rectangles.
