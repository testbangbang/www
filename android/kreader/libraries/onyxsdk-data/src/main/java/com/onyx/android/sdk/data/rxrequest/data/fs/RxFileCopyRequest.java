 ...
 */
public class RxFileCopyRequest extends RxBaseFSRequest {
    ...
    public RxFileCopyRequest(DataManager dataManager,final List<File> sourceFiles, final File targetDir, boolean isCut) {
        super(dataManager);
    ...
    @Override
    public RxFileCopyRequest call() throws Exception {
    ...
    private void processFileCopy() throws ContentException {
        ...
        while (true) {
            if (getAbort() || CollectionUtils.isNullOrEmpty(getSourceFlattenedFileList())) {
                return;
            }
