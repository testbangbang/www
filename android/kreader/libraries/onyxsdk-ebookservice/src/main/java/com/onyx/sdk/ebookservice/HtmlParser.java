...
/**
 * Created by suicheng on 2017/2/10.
 */
public class HtmlParser {
    ...
    public HtmlParser(File in, String charsetName, String baseUri)
            throws IOException {
        super();
        mDocument = Jsoup.parse(in, charsetName, baseUri);
    }

    public HtmlParser(URL url, int timeoutMillis) throws IOException {
        super();
