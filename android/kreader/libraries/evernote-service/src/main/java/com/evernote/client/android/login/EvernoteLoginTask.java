...
import com.evernote.client.android.EvernoteOAuthDialog;
 ...
 */
/*package*/ public class EvernoteLoginTask extends Task<Boolean> {
    ...
    private boolean startAuthorization() {
        ...
        if (callback != null) {
            ...
            String url = intent.getStringExtra(EvernoteUtil.EXTRA_AUTHORIZATION_URL);
            EvernoteOAuthDialog dialog = new EvernoteOAuthDialog();
    ...
    public interface LoginTaskCallback {
        ...
        void onDismiss(int requestCode, int resultCode, Intent data);
    }
}
