...
public class InitReaderViewFunctionBarAction extends BaseReaderAction {
    ...
    public void execute(ReaderDataHolder readerDataHolder) {
        ...
        ReaderFunctionBarItem catalog = new ReaderFunctionBarItem(ViewConfig.FunctionModule.LIBRARY,LibraryFragment.class.getName(),
                JDReadApplication.getInstance().getString(R.string.reader_menu_catalog), R.mipmap.ic_read_list,new ReaderFunctionItemCatalogEvent());
        ...
        ReaderFunctionBarItem progress = new ReaderFunctionBarItem(ViewConfig.FunctionModule.SHOP, ShopFragment.class.getName(),
                JDReadApplication.getInstance().getString(R.string.reader_menu_progress), R.mipmap.ic_read_pace,new ReaderFunctionItemProgressEvent());
        ...
        if (PreferenceManager.getBooleanValue(JDReadApplication.getInstance(), R.string.show_back_tab_key, false)) {
            ReaderFunctionBarItem back = new ReaderFunctionBarItem(ViewConfig.FunctionModule.BACK,"back",
                    JDReadApplication.getInstance().getString(R.string.back_name), R.mipmap.ic_undo,new ReaderFunctionItemBackEvent());
