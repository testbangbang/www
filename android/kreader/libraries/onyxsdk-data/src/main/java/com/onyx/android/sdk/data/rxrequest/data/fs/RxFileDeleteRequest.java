 ...
 */
public class RxFileDeleteRequest extends RxBaseFSRequest {
    ...
    public RxFileDeleteRequest(DataManager dataManager,final List<File> sourceFiles) {
        super(dataManager);
        this.sourceFiles = sourceFiles;
    }

    public RxFileDeleteRequest(DataManager dataManager,final List<File> sourceFiles, FileErrorPolicy errorPolicy) {
        super(dataManager);
        this.sourceFiles = sourceFiles;
    ...
    @Override
    public RxFileDeleteRequest call() throws Exception {
        processFileRemove();
        return this;
    }
    ...
    private void processFileRemove() throws ContentException {
        ...
        while (true) {
            if (getAbort() || CollectionUtils.isNullOrEmpty(sourceFlattenedFileList)) {
                return;
            }
