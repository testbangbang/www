...
public class RxBookRecommendedListRequest extends RxBaseBookStoreRequest {

    private final String params;
    private ProductResult<Product> result;

    public RxBookRecommendedListRequest(String params) {
        this.params = params;
    }

    @Override
    public RxBookRecommendedListRequest call() throws Exception {
        try {
            Response<ProductResult<Product>> response = getService().bookRecommendedList(params).execute();
