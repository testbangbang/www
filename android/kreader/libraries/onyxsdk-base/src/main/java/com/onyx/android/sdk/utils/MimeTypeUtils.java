...
/**
 * Created by solskjaer49 on 14/12/10 16:48.
 */
public class MimeTypeUtils {
    ...
    public static final String mimeType(final String extensionWithoutDot) {
        for(String[] contentTypeMapEntry : MIME_TYPE_BY_EXTENSION_MAP) {
            if (contentTypeMapEntry[0].equalsIgnoreCase(extensionWithoutDot)) {
    ...
    public static boolean isAudio(String mimeType) {
        return !StringUtils.isNullOrEmpty(mimeType) && mimeType.contains(AUDIO_PREFIX);
    }

    public static boolean isTextType(String mimeType) {
        return mimeType.contains(TEXT_PREFIX);
    }

    public static boolean isImageType(String mimeType) {
        return mimeType.contains(IMAGE_PREFIX);
    }

    public static boolean isAudioType(String mimeType) {
        return mimeType.contains(AUDIO_PREFIX);
    }

    public static boolean isVideoType(String mimeType) {
        return mimeType.contains(VIDEO_PREFIX);
    }
