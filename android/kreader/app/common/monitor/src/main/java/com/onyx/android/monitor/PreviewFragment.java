...
public class PreviewFragment extends Fragment
     ...
     */
    private static final int MAX_PREVIEW_HEIGHT = 2060;
    ...
    /**
     * The whole of preview layout.
     */
    private FragmentPreviewBasicBinding binding;
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        for (Size option : choices) {
            Log.d(TAG, "option.getWidth():" + option.getWidth());
            Log.d(TAG, "option.getHeight():" + option.getHeight());
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        binding.texture.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
    ...
    private AlertDialog getExitAlertDialog() {
        ...
        exitConfirmDialog = new AlertDialog.Builder(getActivity()).setMessage(R.string.exit_confirm)
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                showCamera2SupportLevel(characteristics, cameraId);
