...
public class Constant {
    ...
    public static final String CN_HOST_BASE = "http://store.onyx-international.cn:9000";
    public static final String CN_API_BASE = "http://store.onyx-international.cn:9000/api/1";
