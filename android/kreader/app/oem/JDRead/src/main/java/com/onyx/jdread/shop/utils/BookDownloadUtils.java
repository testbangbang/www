...
public class BookDownloadUtils {
    ...
    private static void downloadBook(ShopDataBundle dataBundle, BookDetailResultBean.DetailBean bookDetailBean) {
        ...
        DownloadAction downloadAction = new DownloadAction(getAppContext(), bookDetailBean.downLoadUrl, localPath, bookDetailBean.name + Constants.WHOLE_BOOK_DOWNLOAD_TAG);
