...
template<class RC> class __ForbidAddRefAndRelease : public RC
{
private:
	virtual void addRef() = 0;
	virtual void release() = 0;
...
public:
	 ...
	 */
#ifdef _DEBUG
	__ForbidAddRefAndRelease<RC>* operator->() const { return (__ForbidAddRefAndRelease<RC>*)m_ptr; }
#else
...
/**
 *  Class to expose T3 logging to clients
 */
#ifndef LOGGING_ENABLED
#define LOGGING_ENABLED PRE_RC_ONLY
#endif

#if LOGGING_ENABLED
#define LOG_FLOW(...) dp::Logger::log(dp::Logger::kFlow, __VA_ARGS__)
#define LOG_PERFTEST(...) dp::Logger::log(dp::Logger::kPerfTest, __VA_ARGS__)
#define LOG_PROFILE(...) dp::Logger::log(dp::Logger::kProfile, __VA_ARGS__)
