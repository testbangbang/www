...
public class StoreFreeJournalAction extends BaseAction<StoreDataBundle> {

    private Context context;
    private BookStoreViewModel storeViewModel;

    public StoreFreeJournalAction(Context context) {
    ...
    public void execute(StoreDataBundle storeDataBundle, final RxCallback rxCallback) {
        ...
        body.put(CloudApiContext.BookstoreModule.ID, CloudApiContext.BookstoreModule.FREE_JOURNALS_ID);
        body.put(CloudApiContext.BookstoreModule.MODULE_TYPE, CloudApiContext.BookstoreModule.FREE_JOURNALS_MODULE_TYPE);
        ...
        request.execute(new RxCallback<RxRequestBookstoreModule>() {
            ...
            public void onNext(RxRequestBookstoreModule request) {
                ...
                if (rxCallback != null) {
                    rxCallback.onNext(StoreFreeJournalAction.this);
