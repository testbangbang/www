...
public class PopupAdapter extends PageRecyclerView.PageAdapter<PopupAdapter.ViewHolder> {
    ...
    public ViewHolder onPageCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = View.inflate(parent.getContext(), R.layout.spinner_list_item, null);
