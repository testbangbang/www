...
public class ActivityUtil
{
    ...
    public static boolean startActivityForResultSafelyWithTimeoutWakeLock(Activity from, Intent intent, int requestCode, long timeout) {
        try {
            from.startActivityForResult(intent, requestCode);
            DeviceInfo.currentDevice.newWakeLock(from, TAG + "startActivityForResultSafelyWithWakeLock").acquire(timeout);
            return true;
        } catch (Throwable tr) {
            Log.e(TAG, "", tr);
        }
