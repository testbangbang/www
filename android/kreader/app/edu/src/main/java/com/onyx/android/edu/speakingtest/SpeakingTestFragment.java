 ...
 */
public class SpeakingTestFragment extends BaseFragment implements SpeakingTestContract.View, View.OnClickListener, TestAdapter.OnItemClickListener {

    private static final String TAG = SpeakingTestFragment.class.getSimpleName();
