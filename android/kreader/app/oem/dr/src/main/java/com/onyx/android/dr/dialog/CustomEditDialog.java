...
/**
 * Created by hehai on 2016/12/14.
 */
public class CustomEditDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CustomEditDialog create() {
            ...
            final CustomEditDialog dialog = new CustomEditDialog(context, R.style.Dialog);
            ...
            if (contentView != null) {
                ...
                ((LinearLayout) layout.findViewById(R.id.content_result))
                        .removeAllViews();
                ((LinearLayout) layout.findViewById(R.id.content_result))
