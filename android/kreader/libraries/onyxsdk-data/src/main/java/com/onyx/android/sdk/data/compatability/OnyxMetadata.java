...
public class OnyxMetadata implements Parcelable
{
    ...
    public static class Columns implements BaseColumns
    {
        ...
        public static ContentValues createColumnData(OnyxMetadata data)
        {
            ...
            values.put(LIB_REF_COUNT, data.getLibRefCount());
            return values;
        }
    ...
    public Object clone() {
        ...
        data.setLibRefCount(libRefCount);
        return data;
    }
    ...
    public int getLibRefCount() { return this.libRefCount; }

    public void setLibRefCount(int refCount) { this.libRefCount = refCount; }
    ...
    public void readFromParcel(Parcel source)
	{
        ...
        libRefCount = source.readInt();
    }
	
	public static final Creator<OnyxMetadata> CREATOR
								= new Creator<OnyxMetadata>()
	{
