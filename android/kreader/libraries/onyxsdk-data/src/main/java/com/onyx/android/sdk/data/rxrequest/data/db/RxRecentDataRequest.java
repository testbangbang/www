...
public class RxRecentDataRequest extends RxBaseDBRequest {
    ...
    public RxRecentDataRequest call() throws Exception {
        ...
        DataModelUtil.metadataToDataModel(eventBus, recentAddList, recentlyAddMetadata, thumbnailMap, ThumbnailUtils.defaultThumbnailMapping());
        DataModelUtil.metadataToDataModel(eventBus, recentlyReadList, recentlyReadMetadata, thumbnailMap, ThumbnailUtils.defaultThumbnailMapping());
        return this;
    }
