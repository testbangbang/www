...
public class ApplicationSettingUtil {
    private static final String ADB_KEY = CommonUtil.apiLevelCheck(Build.VERSION_CODES.JELLY_BEAN_MR1) ? Settings.Global.ADB_ENABLED : Settings.Secure.ADB_ENABLED;
