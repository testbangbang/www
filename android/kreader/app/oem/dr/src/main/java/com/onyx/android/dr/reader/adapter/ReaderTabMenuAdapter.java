...
public class ReaderTabMenuAdapter extends PageRecyclerView.PageAdapter<ReaderTabMenuAdapter.ViewHolder> implements View.OnClickListener {
    private List<ReaderMenuBean> menuDataList;

    public void setMenuDataList(List<ReaderMenuBean> menuDataList) {
    ...
    public void onPageBindViewHolder(ViewHolder holder, int position) {
        ReaderMenuBean menuData = menuDataList.get(position);
        setImage(menuData, holder.tabMenuIcon);
        holder.tabMenuTitle.setText(menuData.getTabName());
        holder.rootView.setTag(position);
        holder.rootView.setEnabled(menuData.isEnable());
        holder.rootView.setOnClickListener(this);
    }

    private void setImage(ReaderMenuBean menuData, ImageView tabMenuIcon) {
