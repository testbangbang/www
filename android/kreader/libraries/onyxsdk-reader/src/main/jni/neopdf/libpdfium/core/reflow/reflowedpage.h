...
#include "../fpdfapi/fpdf_page/include/cpdf_form.h"
#include "../fpdfapi/fpdf_page/include/cpdf_formobject.h"

#include "include/reflowengine.h"
...
public:
    ...
    CPDF_Dictionary* GetFormDict()
    {
        ...
        if (NULL == pParentObj || CPDF_PageObject::FORM != pParentObj->GetType()) {
            return NULL;
        }
