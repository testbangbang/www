...
public class FileOpenWithRequest extends BaseFSRequest {
    ...
    public FileOpenWithRequest(File file, Map<String, JSONArray> appIgnoreListMap,
    ...
    private void processGetAppListForSpecificFile(File file) {
        ...
        AppPreference appPreference = loadAppPreference(getContext(), file);
    ...
    private AppDataInfo getAppDataInfo(ResolveInfo info) {
        AppDataInfo appInfo = ApplicationUtil.appDataFromApplicationInfo(info.activityInfo,
                ApplicationUtil.getPackageInfoFromPackageName(getContext(), info.activityInfo.packageName),
